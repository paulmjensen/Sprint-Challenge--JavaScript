...
let universities = graduates.map(function(element){
...
let contactInfo = graduates.map(function(element){
  return `${element.first_name} ${element.email}`;
})
console.log(contactInfo);

/* Request 3: Find out how many universities have the string "Uni" included in their name. Create a new array called unisWithUni that contains them all. This will be an array of objects. Log the result. */
let unisWithUni = graduates.filter(function(element){
...
let lowCaseAnimalNames = zooAnimals.map(function(element){
...
let populationTotal = zooAnimals.reduce(function(SumTotal, element){
  return SumTotal + element.population;
}, 0)
